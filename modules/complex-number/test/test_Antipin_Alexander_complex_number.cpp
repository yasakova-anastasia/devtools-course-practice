...
TEST(Antipin_Alexander_ComplexNumberTest, can_create_complex_number_without_throws) {
    ASSERT_NO_THROW(ComplexNumber(1.0, 2.0));
}

TEST(Antipin_Alexander_ComplexNumberTest, can_create_complex_number_correct_1) {
    double re{};
    double im{ 1.0 };
...
TEST(Antipin_Alexander_ComplexNumberTest, can_create_complex_number_correct_2) {
    double re{};
    double im{ 1.0 };
