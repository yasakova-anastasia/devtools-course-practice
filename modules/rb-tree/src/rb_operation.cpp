...
std::string InsertOperation::operator()(RBTree& tree, const std::vector<int>& arg) {
    tree.insert(new Node{arg[0]});
    return "";
}
std::string FindOperation::operator()(RBTree& tree, const std::vector<int>& arg) {
...
std::string RemoveOperation::operator()(RBTree& tree, const std::vector<int>& arg) {
    try {
        tree.remove(arg[0]);
        return "";
...
std::string GetRootOperation::operator()(RBTree& tree, const std::vector<int>& arg) {
