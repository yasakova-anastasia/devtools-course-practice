...
class Bitfield
{
    ...
    public:
        ...
        int get(unsigned int position) const; // Return the value of specified position in Bitfield object.
        unsigned int get_size() const; // Return the size of Bitfield object.
